...
# API KEYS
#region
API_KEY = "PK79MI94LS8O3FDGLJYD"
API_SECRET = "ovEoCbtjtRU2oUTF8rl3QCfHUDRUJUCrwPIWrkHY"
...
class EMA:
  ...
  def run(self):
        ...
        conn = StreamConn('3nr952L2TEcr1xhCpRdEnApaMRfxD2Vv', '3nr952L2TEcr1xhCpRdEnApaMRfxD2Vv', 'wss://socket.polygon.io/stocks')
